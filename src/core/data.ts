...
export const GEAR: Record<GearCategory, GearItem[]> = {
  platines: [
    ...
    { category: 'platines', tier: 1, nom: 'Contrôleur d’occase', price: 350, value: 1.0, seizable: true },
  ...
  mur: [
    ...
    { category: 'mur', tier: 1, nom: 'Stack honnête', price: 400, value: 1.0, seizable: true },
  ...
  groupe: [
    ...
    { category: 'groupe', tier: 1, nom: 'Groupe de chantier', price: 300, value: 0.8, seizable: true },
  ...
  lumieres: [
    ...
    { category: 'lumieres', tier: 1, nom: 'Barre de LEDs', price: 250, value: 0.06, seizable: true },
  ...
  logistique: [
    ...
    { category: 'logistique', tier: 1, nom: 'Deux guetteurs', price: 300, value: 0.85, seizable: true },
